...
import * as Schemas from '../../../jsonrpc-types/src/schemas/validated';
import { z } from 'zod';
...
export class ValidatedMethods {
   ...
   */
  async status(params: Types.StatusRequest = {}): Promise<Types.StatusResponse> {
    try {
   ...
   * // Result will contain: header, chunks
   */
  async block(params: Types.BlockRequest = {}): Promise<Types.BlockResponse> {
    try {
   ...
   */
  async chunk(params: Types.ChunkRequest): Promise<Types.ChunkResponse> {
    try {
   ...
   */
  async query(params: Types.QueryRequest): Promise<Types.QueryResponse> {
    try {
   ...
   */
  async validators(params: Types.ValidatorsRequest = {}): Promise<Types.ValidatorsResponse> {
    try {
   ...
   */
  async gasPrice(params: Types.GasPriceRequest = {}): Promise<Types.GasPriceResponse> {
    try {
   ...
   */
  async networkInfo(params: Types.NetworkInfoRequest = {}): Promise<Types.NetworkInfoResponse> {
    try {
   ...
   */
  async tx(params: Types.TransactionRequest): Promise<Types.TransactionResponse> {
    try {
   ...
   */
  async broadcastTxAsync(params: Types.BroadcastTransactionRequest): Promise<string> {
    try {
   ...
   * // Result will contain: status, transaction, transactionOutcome
   */
  async broadcastTxCommit(params: Types.BroadcastTransactionRequest): Promise<Types.TransactionResponse> {
    try {
